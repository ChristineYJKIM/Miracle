...
public class LoginActivity_NR extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstance){
       ...
       /* if(mAuth !=null){
            Intent intent = new Intent(LoginActivity_NR.this, HomeActivity.class);
        ...
        loginQn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(LoginActivity_NR.this, RegistrationActivity.class);
                startActivity(intent);
            }
        });
                        ...
                        mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if(task.isSuccessful()){
                                    ...
                                    Toast.makeText(LoginActivity_NR.this, "로그인 실패", Toast.LENGTH_SHORT).show();
